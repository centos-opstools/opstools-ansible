 ...
 *Just create the inventory and overwritten if it exits:
    ...
    def _create_hosts_file(self):
        ...
        if not os.path.exists(_path) or self.options.force:
            ...
            if len(hosts) == 0:
                ...
                os.remove(_path)
                raise NoHostsException('There is no hosts to install the'
                                       ' services')
    ...
    def create_configuration(self):
        ...
        except NoHostsException as e:
            print('Error: {}'.format(e.description))
